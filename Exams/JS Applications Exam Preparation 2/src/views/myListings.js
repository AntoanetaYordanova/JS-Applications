import { getUserCarListing } from '../api/data.js';
import { html } from '../lib.js';
import { getUserData } from '../util.js';

const template = (cars) => html`  <section id="my-listings">
...
export async function myListingsPage(ctx) {
    ...
    const carsData = await getUserCarListing(userData.id);
    ctx.render(template(carsData));
}