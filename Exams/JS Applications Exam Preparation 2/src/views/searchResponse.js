...
const searchTemplate = (cars, onSubmit) => html`<section id="search-cars">
...
export async function searchResponsePage(ctx) {
    const carsData = await getCarsByYear(ctx.params.year);

    ctx.render(searchTemplate(carsData, onSubmit));
